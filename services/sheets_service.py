...
def smart_query(query_text: str) -> dict:
    ...
    try:
        ...
        cat_map = {
            ...
            "продукт": "Продукты", "еда": "Продукты",
            "кафе": "Кафе", "ресторан": "Кафе",
            "транспорт": "Транспорт", "бензин": "Транспорт", "билет": "Транспорт",
            "одежд": "Одежда",
            "медицин": "Медицина", "аптек": "Аптека", "лекарств": "Аптека",
            "здоровь": "Медицина",
            "животн": "Животные", "корм": "Животные",
            "красот": "Красота", "косметик": "Красота",
            "подписки ии": "Подписки ИИ", "подписки и": "Подписки ИИ",
            "клод": "Подписки ИИ", "claude": "Подписки ИИ", "нейросет": "Подписки ИИ",
            "подписк": "Подписки",
            ...
            "хозтовар": "Хозтовары", "посуд": "Хозтовары",
            "техник": "Бытовая техника", "прибор": "Бытовая техника",
            "развлечени": "Развлечения", "досуг": "Развлечения",
            "алкогол": "Алкоголь", "табак": "Табак",
            "электротовар": "Электротовары", "гирлянд": "Электротовары",
            "прочее": "Прочее",
        }
