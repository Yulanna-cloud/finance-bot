...
- Если остаток равен 0 или отрицательный — не добавляй строку Продукты

Категории товаров:
- Табак: сигареты, табак, вейп, папиросы
- Бытовая химия: мыло, шампунь, зубная щетка/паста, порошок, фейри, туалетная бумага, салфетки
- Красота: косметика, тени, тушь, помада, крем для лица, лак для волос
- Одежда: одежда, обувь, носки, трусы
- Электротовары: гирлянда, лампочка, батарейки, удлинитель, провод
- Продукты: еда, напитки, молочка, мясо, хлеб, фрукты, овощи
- Прочее: всё что не подходит ни к одной категории выше

Верни массив где каждый элемент:
{{"категория":"Табак","сумма":185,"описание":"сигареты"}}

Последним элементом добавь остаток в Продукты с описанием "продукты" если остаток больше 0.
Пример: общий чек 872, перечислено товаров на 434 → остаток 438 → добавь {{"категория":"Продукты","сумма":438,"описание":"продукты"}}.
"""
