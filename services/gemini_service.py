...
Животные, Красота, Бытовая химия, Бытовая техника, Одежда, Развлечения, Подписки, Подписки ИИ, Связь, Табак, Доход, Переводы, Прочее
...
Категории: Продукты, Бытовая химия, Бытовая техника, Табак, Красота, Одежда, Прочее"""
...
Категории: Продукты, Кафе, Транспорт, Жилье, Коммуналка, Медицина, Одежда, Развлечения, Подписки, Табак, Бытовая химия, Бытовая техника, Доход, Прочее
Выписка:
{text[:4000]}"""
        response = groq_client.chat.completions.create(
            model="llama-3.3-70b-versatile",
