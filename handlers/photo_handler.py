...
def read_receipt_with_groq(image_bytes: bytes) -> dict | None:
    ...
    try:
        ...
        prompt = """Ты читаешь фотографию кассового чека.
...
- Бытовая химия: порошок, моющие средства, зубная паста, туалетная бумага
- Табак: сигареты, табак, вейп
- Алкоголь: пиво, вино, водка, коньяк, шампанское
- Красота: косметика, духи, крем для лица/тела
