...
CATEGORY_KEYWORDS = {
    ...
    "Хозтовары":     ["хозтовар", "посуда", "тарелк", "кастрюл", "сковород", "контейнер",
                      "органайзер", "вешалк", "прищепк", "швабра", "ведро", "губка", "тряпка"],
    ...
    "Связь":         ["мтс", "билайн", "мегафон", "теле2", "tele2", "yota", "йота"],
