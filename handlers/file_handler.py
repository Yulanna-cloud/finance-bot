...
- Маргарита П. → категория Дети, тип расход
- Диана Ш. → если приход то Доход, если расход то Дети
- Алексей П. → категория Переводы, тип расход (если приход то Доход)
- Раиса Г. → категория Семья
- Любой другой перевод человеку (Перевод для...) → Переводы
