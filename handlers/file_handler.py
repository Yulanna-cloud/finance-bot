...
2. ОБЯЗАТЕЛЬНО ПРОПУСТИ операции у которых в описании есть любое из: PYATEROCHKA, MAGNIT, KRASNOE, BELOE, MAGAZIN, LENTA, PEREKRESTOK — это супермаркеты,их вводятся вручную. Если видишь эти слова - не включай операцию в результат вообще.
